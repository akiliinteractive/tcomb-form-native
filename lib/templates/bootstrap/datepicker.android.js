...
function datepicker(locals) {
  ...
  if (locals.config) {
    ...
    // adding the ability to change the dialogMode for android this way we can use a spinner instead of a calendar 
      ...
      <TouchableNativeFeedback
        ...
        onPress={function () {
          if (datePickerMode === 'time') {
            ...
            TimePickerAndroid.open({is24Hour: is24Hour, hour: setTime.hour, minute: setTime.minute})
            .then(function (time) {
